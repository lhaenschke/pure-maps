#ifndef TRAINCONNECTIONS_H
#define TRAINCONNECTIONS_H
...
class TrainConnections : public QObject
{
    Q_OBJECT
...
public:
    explicit TrainConnections(QObject *parent = nullptr);
