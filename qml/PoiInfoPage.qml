...
PagePL {
    ...
    property bool isPublicTransport: poi && ((poi.poiType.indexOf("Railway") != -1) || (poi.poiType.indexOf("Bus") != -1)) ? true : false
    ...
    Column {
        ...
        IconListItem {
            ...
            onClicked: {
                app.push(Qt.resolvedUrl("PublicTransportTimeTablesPage.qml"), {
                    "poi": poi,
                });
            }
        }
